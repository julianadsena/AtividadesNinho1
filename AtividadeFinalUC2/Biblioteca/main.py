...
from Modelo.classLivro import Livros
                            ...
                            case "1":
                                ...
                                if resultado != []:
                                    ...
                                    for aluguel in resultado:
                                        livro = Livros(aluguel[2],None, None)
    ...
    match opcoes:
        case "1":
            while True:
                ...
                livroEscolhido = Livros(livroID, None, None)
        ...
        case "2":
            while (True):
                novoLivro = Livros("1",None,None,None,None,None)
                
                novoLivro._nome = input("Digite o nome do livro:")
                novoLivro._paginas = input("Digite o numero de paginas:")
                novoLivro._nome = input("Digite o ano de lancamento:")
                novoLivro._autor = input("Digite o nome do autor:")
                novoLivro._edicao = input("Digite a edicao do livro:")
                
                
                
                conexao.manipularBanco(novoLivro.inserirLivros())
...
while True:
    try:
        ...
        # login = "postgres"
        # password = "postgres"
        con = Conexao("Livraria","localhost","5433",login,password)
        break
...
while True:
    try:
        print("Bem vindo a Livraria 'Livraria Leitura' ")
